...
class Importbutton extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        $startImportButtonHtml = $this->getLayout()->createBlock(
            ...
            ['label' => 'Force Import Now', 'id' => 'mb-sinch-import-button', 'class' => 'mb-start-button', 'style' => 'margin-top:30px']
        )->toHtml();
        ...
        $lastImportData = $this->_sinchFactory->create()->getDataOfLatestImport();
        ...
        if ($lastImportStatus == 'Failed') {
            ...
            $html .= '<div id="sinchimport_current_status_message" name="sinchimport_current_status_message" style="display:true"><br><br><hr/><p class="sinch-success">' . $lastImportData['number_of_products'] . ' products imported succesfully!</p></div>';
    ...
    {
        $completeIcon = $this->_urlBuilder->getBaseUrl(['_type' => UrlInterface::URL_TYPE_MEDIA])
            . 'magebuzz/sinchimport/import_complete.gif';
