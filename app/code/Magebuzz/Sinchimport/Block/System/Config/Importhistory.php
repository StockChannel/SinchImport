...
class Importhistory extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        $sinchFactory = $this->_sinchFactory->create();
        $lastSuccessImport = $sinchFactory->getDateOfLatestSuccessImport();
        $importHistory = $sinchFactory->getImportStatusHistory();
...
<div class="comment last-import-info">' . ($lastSuccessImport ? "Your last successful feed import was at " . $lastSuccessImport : "Your import never finished with success") . '</div>
<table class="data-table history mb-sinch-history">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td  style="padding:10px 5px;" class="' . $cssArr[$item['global_status_import']] . '">' . $item['global_status_import'] . '</td>
