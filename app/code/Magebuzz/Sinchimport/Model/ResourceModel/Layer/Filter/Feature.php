...
namespace Magebuzz\Sinchimport\Model\ResourceModel\Layer\Filter;

/**
 * Magebuzz Layer Feature Filter resource model
 */
class Feature extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    protected function _prepareSearch($filter, $value = null)
    {
        ...
        $resultTable = $connection->getTableName('sinch_filter_result_' . $cfid);
        ...
        $result = $connection->rawQuery("CALL ".$connection->getTableName('sinch_filter_products')."($cfid, $catId,0, $cfid, $params, '$tablePrefix')");
    ...
    public function getCount($filter)
    {
        ...
        $select->joinInner(
                ...
                array('srv' => $connection->getTableName('sinch_restricted_values')),
    ...
    public function getIntervalsCount($filter, $interval)
    {
        ...
        $select->joinInner(
                ...
                array('scf' => $connection->getTableName('sinch_categories_features')),
                "scf.category_feature_id = srv.category_feature_id",
                array()
            )->joinLeft(
                array('scm' => $connection->getTableName('sinch_categories_mapping')),
