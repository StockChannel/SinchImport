    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        if (!empty($lastImportData) && $lastImportData['import_type'] == 'PRICE STOCK') {
            ...
            if ($lastImportStatus == 'Failed') {
                ...
                $html .= '<div id="sinchimport_stock_price_current_status_message" name="sinchimport_stock_price_current_status_message" style="display:true"><br><br><hr/><p class="sinch-processing">Import is running now</p></div>';
            } else {
